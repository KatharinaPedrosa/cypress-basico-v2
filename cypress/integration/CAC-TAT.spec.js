...
describe('Central de Atendimento ao Cliente TAT', function () {
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function () {
        cy.get('#firstName')
            .type('Katharina')
            .should('have.value', 'Katharina')
            .clear()
            .should('have.value', '')
        cy.get('#lastName')
            .type('Pedrosa')
            .should('have.value', 'Pedrosa')
            .clear()
            .should('have.value', '')
        cy.get('#email')
            .type('katharinapedrosa@teste.com')
            .should('have.value', 'katharinapedrosa@teste.com')
            .clear()
            .should('have.value', '')
        cy.get('#phone')
            .type('89625713696')
            .should('have.value', '89625713696')
            .clear()
            .should('have.value', '')
